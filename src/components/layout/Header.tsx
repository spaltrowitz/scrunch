  ...
  return (
    <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 no-underline min-h-[44px] -my-1">
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => signOut()}
                className="text-sm px-4 py-2 min-h-[44px] rounded-xl border border-gray-200 hover:bg-gray-50 cursor-pointer transition"
              >
                Sign Out
              </button>
            </div>
            ...
            <Link
              to="/login"
              className="text-sm px-4 py-2 min-h-[44px] inline-flex items-center rounded-xl bg-violet-600 text-white no-underline hover:bg-violet-700 transition"
            >
              Sign In
            </Link>
          )}
